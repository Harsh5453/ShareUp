...
import { FaBox, FaPlus, FaClipboardList, FaUndo, FaSignOutAlt } from 'react-icons/fa'
  ...
  return (
    <>
      <style>{`
        ...
        .sidebar-logo { font-family: 'Syne', sans-serif; font-size: 1.3rem; font-weight: 800; color: white; letter-spacing: -0.5px; }
        .s-nav-item {
        ...
        .s-nav-item .s-label { font-size: 0.875rem; font-weight: 500; color: #9ca3af; transition: color 0.2s; }
        .s-nav-item:hover .s-icon { background: rgba(232,93,38,0.15); color: #e85d26; }
        .s-nav-item:hover .s-label { color: #fff; }
        .s-nav-item.active .s-icon { background: #e85d26; color: white; }
        .s-nav-item.active .s-label { color: #fff; font-weight: 600; }
        ...
        .s-divider { height: 1px; background: rgba(255,255,255,0.07); margin: 12px 0; }
        .s-logout-btn {
          display: flex; align-items: center; gap: 12px;
          padding: 11px 16px; border-radius: 10px;
        ...
        .s-logout-btn:hover { background: rgba(239,68,68,0.1); }
        .s-logout-btn:hover .s-logout-icon { color: #ef4444; background: rgba(239,68,68,0.15); }
        .s-logout-btn:hover .s-logout-label { color: #ef4444; }
        .s-logout-icon {
          width: 34px; height: 34px; border-radius: 8px;
          display: flex; align-items: center; justify-content: center;
          font-size: 0.85rem; background: rgba(255,255,255,0.07);
        ...
        .s-logout-label { font-size: 0.875rem; font-weight: 500; color: #6b7280; transition: color 0.2s; }
        .s-user-card {
      ...
      <aside className="sidebar-root">
        ...
        <div style={{ padding: '24px 20px 20px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 4 }}>
            <div style={{ width: 30, height: 30, borderRadius: 8, background: 'linear-gradient(135deg, #e85d26, #f59e0b)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          ...
          <div style={{ fontSize: '0.7rem', color: '#4b5563', textTransform: 'uppercase', letterSpacing: '0.1em', paddingLeft: 2 }}>Owner Panel</div>
        </div>
        ...
        {/* Bottom */}
        <div>
          <div className="s-divider" style={{ margin: '12px' }} />
          ...
          <div style={{ padding: '0 12px 16px' }}>
            <button className="s-logout-btn" onClick={handleLogout}>
              <div className="s-logout-icon"><FaSignOutAlt /></div>
              <span className="s-logout-label">Logout</span>
            </button>
          </div>
        </div>
      </aside>
