    ...
    <>
      <style>{`
        ...
        *{box-sizing:border-box}
        ...
        .rc{background:white;border-radius:20px;border:1px solid #f0ede8;padding:36px 32px;width:100%;max-width:440px;box-shadow:0 4px 24px rgba(0,0,0,0.07)}
        ...
        .rs{font-size:0.85rem;color:#9ca3af;margin-bottom:28px}
        ...
        .rf input, .rf select{width:100%;border:1.5px solid #e5e0d8;border-radius:10px;padding:11px 14px;font-size:0.9rem;font-family:'DM Sans',sans-serif;color:#111;outline:none;transition:border-color 0.2s;background:#faf9f6}
        .rf input:focus, .rf select:focus{border-color:#e85d26;background:white}
        .rf input::placeholder{color:#b0a99f}
        ...
        .rdiv{height:1px;background:#f0ede8;margin:24px 0}
        .role-grid{display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:14px}
        .role-card{
          border:2px solid #e5e0d8;border-radius:12px;padding:14px 12px;
          cursor:pointer;transition:all 0.2s;text-align:center;background:#faf9f6;
          display:flex;flex-direction:column;align-items:center;gap:6px;
        }
        .role-card:hover{border-color:#e85d26}
        .role-card.selected{border-color:#e85d26;background:#fff8f5}
        .role-card input{display:none}
        .role-icon{font-size:1.4rem}
        .role-title{font-size:0.82rem;font-weight:600;color:#111}
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="rrow">
              <div className="rf">
                ...
                <input {...register('name')} placeholder="Harsh Sharma" />
